...
struct Home10: View {
    @State var scene: SCNScene? = .init(named: "LightBlue.scn")
...
//            }
            ...
            HStack{
                ...
                VStack(alignment: .leading, spacing: 10) {
                    Text("This photograph is the 10th photograph out of the Chi Scrappers Collection.")
                        .font(.callout)
                        .fontWeight(.semibold)
                        .foregroundColor(.gray)
...
struct Home10_Previews: PreviewProvider {
